...
- **NOTE:** Tested numbers will be shown in console log, if you want to pause and continue later, write the last number tested in a notepad (or something like that) and later change the int number variable that initializes with 0 to your saved number.
